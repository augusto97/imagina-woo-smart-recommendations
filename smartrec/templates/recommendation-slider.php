<?php
/**
 * Template: Slider Layout for SmartRec Recommendations
 *
 * Horizontal scrolling carousel using CSS scroll-snap.
 *
 * Available variables:
...
<div class="smartrec-widget smartrec-widget--slider<?php echo $css_class; ?>" style="--smartrec-columns: <?php echo esc_attr( $columns ); ?>;">

	<?php if ( ! empty( $title ) ) : ?>
		<div class="smartrec-widget__header">
			<h2 class="smartrec-widget__title"><?php echo esc_html( $title ); ?></h2>
			<div class="smartrec-widget__nav">
				<button type="button"
						class="smartrec-widget__nav-btn smartrec-widget__nav-btn--prev"
						aria-label="<?php esc_attr_e( 'Previous', 'smartrec' ); ?>">
					&#8249;
				</button>
				<button type="button"
						class="smartrec-widget__nav-btn smartrec-widget__nav-btn--next"
						aria-label="<?php esc_attr_e( 'Next', 'smartrec' ); ?>">
					&#8250;
				</button>
			</div>
		</div>
	...
	<div class="smartrec-widget__slider">
